...
|-----------|-----------|
| **Язык** | Go 1.25.13 (патч с фиксами stdlib-уязвимостей; не ниже 1.25.13) |
| **HTTP-фреймворк** | Gin |
| **ORM** | GORM (PostgreSQL) |
...
- Go 1.25.13+ (не ниже — stdlib-уязвимости GO-2026-6088..6218 исправлены в 1.25.13)
- PostgreSQL 18+
- Node.js 20+ и npm (сборка CSS, E2E-тесты; в CI — Node 24)
