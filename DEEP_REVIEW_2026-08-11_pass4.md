...
12. ✅ **M2** (лимиты импорта CSV), **M5** (личный чат — rate-limit), **M9** (ics cache host), **M11** (кэш статистики профиля).
13. ✅ **L1/L2** (nil-проверки admin), **L4** (guard StartedAt), **L8** (social 404), **L9** (export 500).
14. ✅ **P3** (calendar singleflight).
15. ⏳ Остались задокументированные: **P4** (CreateInBatches — рискованный), **L3/L5/L6/L7/L10-L12**, **P5-P10**.
