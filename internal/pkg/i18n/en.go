...
var enMessages = map[string]string{
	...
	"twofa.already_enabled":          "Two-factor authentication is already enabled",
	...
	"auth.verify_code_label":      "Verification code",
	"auth.verify_button":          "Verify",
	"auth.verify_code_hint":       "Enter the code from the email. If it didn't arrive, check your Spam folder.",
	...
	"dashboard.all_notifications":       "View all",
	"dashboard.unread":                  "unread",
	"dashboard.calendar_title":          "Games calendar",
	"dashboard.calendar_open":           "Open calendar",
	...
	"dashboard.progress_levels":         "Level %d of %d",
	...
	"profile.game_reminders":        "Upcoming game reminders",
	"profile.game_reminders_desc":   "How many days before a game to send a notification",
	"profile.remind_never":          "Never notify",
	"profile.remind_days":           "In %d days",
	...
	"profile.theme_settings_desc": "Choose how the site theme switches: follow your system, a time window, or stay fixed.",
	"profile.theme_mode_label":    "Theme mode",
	"profile.theme_mode_system":   "System (follow OS)",
	"profile.theme_mode_time":     "By time window",
	"profile.theme_mode_dark":     "Always dark",
	"profile.theme_mode_light":    "Always light",
	...
	"payment.disabled":                  "Payments are temporarily unavailable",
	"payment.create_title":              "Create payment",
	"payment.amount":                    "Amount",
	"payment.description":               "Purpose",
	"payment.create_button":             "Pay",
	...
	"game.settings_limits_title":     "Team roster limits (0 = unlimited)",
	"game.settings_max_hq":           "Max players at HQ",
	"game.settings_max_field":        "Max players in the field",
	"game.settings_max_cars":         "Max cars per team",
	...
	"coauthor.role_label":          "Role",
	"coauthor.role_content_editor": "Content editor",
	"coauthor.role_moderator":      "Moderator",
	"coauthor.role_observer":       "Observer",
	"coauthor.permissions_label":   "Extra permissions:",
	"coauthor.perm_edit_content":   "Levels, questions, answers, hints",
	"coauthor.perm_upload_media":   "Photo and video materials",
	"coauthor.perm_moderate":       "Moderation (content removal)",
	...
	"team.leave_confirm":         "Leave the team?",
	...
	"gamechat.create_room":       "Create room",
	"gamechat.room_name":         "Room name",
	"gamechat.room_create":       "Create",
	...
	"notif.more":                "Details →",
	"notif.upcoming_game_title": "Game starts soon",
	"notif.upcoming_game_body":  "Upcoming game",
	"notif.new":                 "New",
	...
	"admin.create_user_title":           "Create player",
	"admin.create_user_button":          "Create",
	"admin.create_user_ok":              "Player created",
	"admin.create_user_invalid":         "Invalid data: email, name and password (min 8 chars) are required",
	"admin.create_user_invalid_email":   "Invalid email format",
	"admin.create_user_error":           "Failed to create player",
	"admin.create_user_exists":          "User with this email already exists",
	"admin.name":                        "Name",
	"admin.password":                    "Password",
	"admin.create_team_title":           "Create team",
	"admin.create_team_button":          "Create",
	"admin.create_team_ok":              "Team created",
	"admin.create_team_invalid":         "Provide a team name and captain ID",
	"admin.create_team_captain_missing": "Captain with this ID not found",
	"admin.create_team_error":           "Failed to create team",
	"admin.team_name":                   "Team name",
	"admin.captain_id":                  "Captain ID",
